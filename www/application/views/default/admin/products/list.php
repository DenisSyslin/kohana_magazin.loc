...
<div id="container">
    <div class="container">
        <div class="row title">
	        <div class="span12">
                <h1 class="pull-left"><?php echo __('Список продуктов') ?></h1>
                <a class="btn btn-success pull-right"
                   href="<?php echo URL::site('/admin/products/new') ?>"><i class="icon-plus"></i> <?php echo __('Новый') ?></a>
	        </div>
        </div>
                    ...
                    <tbody>
				        <?php if (!empty($items)) : ?>
	                        ...
	                        <tr>
	                            ...
	                            <td class="actions">
		                            <div class="btn-group">
		                                <a class="btn" href="<?php echo URL::site('admin/products/delete/' . $item[ 'id' ]) ?>">
											<i class="icon-remove"></i> <?php echo __('Удалить') ?>
										</a>
		                                <a class="btn btn-primary" href="<?php echo URL::site('admin/products/edit/' . $item[ 'id' ]) ?>">
					    ...
					    <?php else: ?>
		                    <tr>
		                        <td colspan="6"><?php echo 'Нет продуктов' ?></td>
		                    </tr>
					    <?php endif; ?>
                    </tbody>
